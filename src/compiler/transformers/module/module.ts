...
namespace ts {
    ...
    export function transformModule(context: TransformationContext) {
        ...
        const voidZeroLiteral = factory.createVoidZero();
        ...
        function substituteExpressionOfCallLike(node: Expression) {
            ...
            if (substitute !== node) {
                return setTextRange(factory.createParenthesizedExpression(factory.createComma(voidZeroLiteral, substitute)), node)
            }
            return node;
        }
